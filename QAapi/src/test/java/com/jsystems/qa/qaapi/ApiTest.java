...
//                .body("[0].device[0].device.model", equalTo("dell") - to nie przejdzie, bo . oznacza kolejne zagniezdzenie
        ;
    ...
    @Test
    @DisplayName("Should return correctly list of users using jsonPath mapping")
